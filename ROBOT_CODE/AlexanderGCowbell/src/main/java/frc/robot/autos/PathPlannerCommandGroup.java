...
public class PathPlannerCommandGroup extends SequentialCommandGroup {
    public PathPlannerCommandGroup(String pathPlannerFile, boolean isRedAlliance, Swerve s_Swerve, PoseEstimatorSubsystem s_PoseEstimatorSubsystem, ArmStateMachine sm_ArmStateMachine) {
        ...
        eventMap.put("ScoreConeHigh", new SequentialCommandGroup(new WaitCommand(0), new AutoScoreCommand(sm_ArmStateMachine, ArmSequence.SCORE_HIGH, GamePiece.CONE)));
        ...
        eventMap.put("ScoreCubeHigh", new SequentialCommandGroup(new WaitCommand(0), new AutoScoreCommand(sm_ArmStateMachine, ArmSequence.SCORE_HIGH, GamePiece.CUBE)));
