...
public class CSVCharacterization {

    public static class ArmEncoderValues {
        ...
        public ArmEncoderValues(double proximal_pos, double proximal_vel, double distal_pos, double distal_vel, double wrist_pos) {
