...
public class ScoreHighConeAuto {
    public static ArmPath getArmPath() {
        return new ArmPath(kNumPoints, proximalPoints, distalPoints, kWristFlexIndex, kWristFlexPosition, kWristExtendIndex, kWristMaxVelocity, autoStartPosition);
    }
    ...
    public static final int autoStartPosition = 50;
